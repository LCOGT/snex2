...
from custom_code.dash_apps import lightcurve, spectra, spectra_individual, base_spectra_individual
...
urlpatterns = [
    ...
    path('load-thumbnail/', load_thumbnail_view, name='load-thumbnail'),
    path('load-airmass-plot/', load_airmass_plot_view, name='load-airmass-plot'),
    path('load-details-tab/', load_details_tab_view, name='load-details-tab'),
    path('load-observations-tab/', load_observations_tab_view, name='load-observations-tab'),
    path('load-manage-data-tab/', load_manage_data_tab_view, name='load-manage-data-tab'),
    path('load-observing-runs-tab/', load_observing_runs_tab_view, name='load-observing-runs-tab'),
