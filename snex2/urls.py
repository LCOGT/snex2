...
urlpatterns = [
    ...
    path('targets/<int:pk>/tab/spectroscopy/', load_spectroscopy_tab_view, name='load-spectroscopy-tab'),
    path('targets/<int:pk>/plot/lightcurve/', load_dash_lightcurve_view, name='load-dash-lightcurve'),
    path('targets/<int:pk>/plot/spectra/', load_spectra_plot_view, name='load-spectra-plot'),
